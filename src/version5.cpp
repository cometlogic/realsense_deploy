...
int main() {
    ...
    */
    ...
    while (true) {
        ...
        // 裁剪 invalid band
        cv::Rect roi(invalid_band_width, 0, final_depth_image.cols - invalid_band_width, final_depth_image.rows);
        final_depth_image = final_depth_image(roi);
